            ...
            function ($document, $templateCache, $compile, $q, $http, $rootScope, $timeout, $window, $controller, $injector) {
                ...
                var publicMethods = {
                    ...
                    closeAll: function (value) {
						...
						if(typeof arr_indicador == 'undefined')
							var arr_indicador = [];
						else
							arr_indicador = ( typeof arr_indicador != 'undefined' && arr_indicador instanceof Array ) ? arr_indicador : [];
                        ...
                        for (var i = $all.length - 1; i >= 0; i--) {
							...
							removeItemFromArr(arr_indicador, i.id);
                        }
                    },
